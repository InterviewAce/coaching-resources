...
class Solution:
    ...
    def compute_quotient(self, dividend, divisor, graph, visited):
        ...
        for neighbor in neighbors:
            ...
            neighbor_over_divisor = self.compute_quotient(neighbor, divisor, graph, visited)
            if neighbor_over_divisor == CANNOT_BE_DETERMINED:
                continue
    ...
    def calcEquation(self, equations: List[List[str]], quotients: List[float], queries: List[List[str]]) -> List[float]:
        ...
        for query in queries:
            ...
            if dividend not in graph or divisor not in graph:
                query_results.append(CANNOT_BE_DETERMINED)
                continue

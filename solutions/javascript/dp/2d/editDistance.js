...
const minDistanceBetweenWords = (word1, word2, word1LastIdx, word2LastIdx, minDistanceCache) => {
    ...
    const minDistanceWithDeletion =
        1 + minDistanceBetweenWords(word1, word2, word1LastIdx - 1, word2LastIdx, minDistanceCache);
    const minDistanceWithInsertion =
        1 + minDistanceBetweenWords(word1, word2, word1LastIdx, word2LastIdx - 1, minDistanceCache);
    const minDistanceWithReplacement =
        1 +
        minDistanceBetweenWords(word1, word2, word1LastIdx - 1, word2LastIdx - 1, minDistanceCache);
...
const minDistance = (word1, word2) => {
    ...
    return minDistanceBetweenWords(word1, word2, word1LastIdx, word2LastIdx, minDistanceCache);
};
